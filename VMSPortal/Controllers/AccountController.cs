...
namespace VMSPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public ActionResult Login(BLL.ViewModel.LoginModel model, string returnUrl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Manage(BLL.ViewModel.LocalPasswordModel model)
        {
            ViewBag.ReturnUrl = Url.Action("Manage");
